...
# This project provides a Python script to parse and process EEG data files (CSV or TXT) using Azure OpenAI's GPT model to generate a function that reads the data, calculates the sampling frequency, and extracts channel names.


# Install the required dependencies:
#    pip install pandas numpy mne openai

## Author

#- Name: Ziyi.Jia
#- Email: Ziyi.Jia23@student.xjtlu.edu.cn
